  ...
  return (
    <div id={id} className={className}>
      <div className="navbar-end">
        <a className="navbar-item" href="https://github.com/dillonredding" target="_blank" rel="noopener noreferrer">
          <Icon name="github" style={IconStyle.Brands} size={IconSize.Large} />
        </a>
        <a className="navbar-item" href="https://twitter.com/dillon_redding" target="_blank" rel="noopener noreferrer">
          <Icon name="twitter" style={IconStyle.Brands} size={IconSize.Large} />
        </a>
        <a className="navbar-item" href="https://dillonredding.medium.com" target="_blank" rel="noopener noreferrer">
